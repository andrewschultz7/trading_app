...
for item in data:
    ...
    cursor.execute(
        "INSERT INTO `trading_data` (`timestamp`, `gmtoffset`, `datetime`, `open`, `high`, `low`, `close`, `volume`, `vwap`) VALUES (?,?,?,?,?,?,?,?,?)",
        (timestamp, gmtoffset, datetime, open, high, low, close, volume, vwap),
    )
